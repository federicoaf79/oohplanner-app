...
export default function Settings() {
  ...
  // Note: the 'commercial', 'confidential_contacts' and 'confidential_reports' tab
  // content blocks remain further down this file as unreachable dead code pending
  // migration to /app/inventory-settings. Do not delete without moving the logic.
  // ('team' has already been migrated.)
  const tabs = [
