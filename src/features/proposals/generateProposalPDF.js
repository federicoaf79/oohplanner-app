...
// C se reasigna en generateProposalPDF según pdfTheme
let C = C_DARK
...
function renderCover(doc, { formData, profile, org, logoB64, generatedAt, validUntil, summaryData }) {
  ...
  fnt(doc, 'normal', 13);  tc(doc, C.accent);           doc.text(san(formData.clientName ?? '-'), 14, y);  y += 12
